		...
		<div class="row">
			<div class="col-md-6">
				<div class="card h-100">
					<h6 class="card-header font-weight-normal text-muted"><a class="hrmis-title text-decoration-none" href="{{ route('Travel Approval') }}"><small class="text-primary font-weight-bold">Travel Order</small></a> <i class="fa fa-angle-double-right fa-xs"></i> <small class="text-muted font-weight-bold">{{ Route::currentRouteName() }}</small></h6>
					<div class="card-body">
				...
				<div class="card h-100">
					...
					<div class="card-footer rounded-0">
                        ...
                        <div class="form-group mb-1">
                            ...
                            <a href="{{ route('Travel Approval') }}" class="btn btn-sm btn-danger btn-block rounded-0">Cancel</a> 
                        </div>
					</div>
					</form>
				</div>
